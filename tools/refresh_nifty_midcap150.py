"""Refresh the cached Nifty Midcap 150 list from NSE archives.

Usage:
    venv/bin/python tools/refresh_nifty_midcap150.py

Writes to ``src/data/symbols/nifty_midcap150.csv``. NSE rebalances Mar/Sep.
"""
...
OUT = Path(__file__).resolve().parent.parent / "src" / "data" / "symbols" / "nifty_midcap150.csv"
