"""Refresh the cached Nifty 500 list from NSE archives.

Usage:
    venv/bin/python tools/refresh_nifty500.py

Writes to ``src/data/symbols/nifty500.csv`` (overwrites in place). Fetches
...
OUT = Path(__file__).resolve().parent.parent / "src" / "data" / "symbols" / "nifty500.csv"
